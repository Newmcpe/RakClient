...
Проект вырос из [RakSAMP Lite](https://www.blast.hk/threads/108052/) — лёгкого клиента, которым вдохновлялся и протокол
которого покрывает целиком, — и идёт дальше: настоящий навмеш, нативный `walkTo` и первоклассный
Luau-хост под серверы Arizona.
