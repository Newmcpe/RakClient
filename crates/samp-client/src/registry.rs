//! Packet-handler registry: the registration-pattern seam between the FSM and observers/scripts, run
//! before the FSM's own logic; see docs/memory/samp-client/registry.md#module.
...
impl PacketRegistry {
    ...
    /// Register a typed handler keyed by the event type, decoded to `T` before it runs; see
    /// docs/memory/samp-client/registry.md#register.
