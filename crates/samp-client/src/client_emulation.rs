//! Standard-client behaviours a real SA-MP client provides and a bare bot omits (ClientCheck answers,
//! weapon inventory, aim/score-ping, vehicle ownership), without which the server drops the
//! connection; see docs/memory/samp-client/client_emulation.md#module.
